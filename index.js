...
(async () => {
  let active = true;
  document.querySelectorAll("#tvShowNetflix").forEach((serie) =>
    serie.addEventListener("click", async (e) => {
...
(async () => {
  let active = true;
  document.querySelectorAll("#trendingMovies").forEach((film) =>
...
(async () => {
  let active = true;
  document.querySelectorAll("#topRated ").forEach((film) =>
    film.addEventListener("click", async (e) => {
      let filmId = parseInt(e.target.attributes[2].value);
      console.log(e.target.attributes);
      //console.log(filmId)
...
(async () => {
  let active = true;
  document.querySelectorAll("#actionsMovies ").forEach((film) =>
    film.addEventListener("click", async (e) => {
      let filmId = parseInt(e.target.attributes[2].value);
      console.log(e.target.attributes);
      //console.log(filmId)
...
(async () => {
  let active = true;
  document.querySelectorAll("#moviesComedie").forEach((film) =>
    film.addEventListener("click", async (e) => {
      let filmId = parseInt(e.target.attributes[2].value);
      console.log(e.target.attributes);
      //console.log(filmId)
...
(async () => {
  let active = true;
  document.querySelectorAll("#moviesDoc").forEach((film) =>
    film.addEventListener("click", async (e) => {
      let filmId = parseInt(e.target.attributes[2].value);
      console.log(e.target.attributes);
      //console.log(filmId)
  ...
  document.getElementById("inputSearch").addEventListener(
    ...
    debounce(async (e) => {
      if (e.target.value) {
        ...
        let infosProgram = await fetchSearching(
        ...
        let containerSearch = document.getElementsByClassName(
          "search-container"
        );
